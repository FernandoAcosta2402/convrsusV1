...
<html lang="en" dir="ltr"><head>
    <meta charset="utf-8">
      ...
      <link rel="stylesheet" href="<?=Url::base()?>/../assets/css/hope-ui.min.css?v=1.1.2">
      
      <!-- Custom Css -->
      <link rel="stylesheet" href="<?=Url::base()?>/../assets/css/custom.min.css?v=1.1.2">
      ...
      <!-- Customizer Css -->
      <link rel="stylesheet" href="<?=Url::base()?>/../assets/css/customizer.min.css">
...
.contract-trigger:before {
  ...
  <body class=" " data-bs-spy="scroll" data-bs-target="#elements-section" data-bs-offset="0" tabindex="0">
      ...
      <section class="login-content">
         <div class="row m-0 align-items-center bg-white vh-100">            
            ...
            <div class="col-md-6 d-md-block d-none bg-primary p-0 mt-n1 vh-100 overflow-hidden">
               <img src="<?=Url::base()?>/../assets/images/auth/01.png" class="img-fluid gradient-main animated-scaleX" alt="images">
            </div>
         </div>
      </section>
      </div>
    ...
    <script src="<?=Url::base()?>/../assets/js/core/libs.min.js"></script>
    
    <!-- External Library Bundle Script -->
    <script src="<?=Url::base()?>/../assets/js/core/external.min.js"></script>
    
    <!-- Widgetchart Script -->
    <script src="<?=Url::base()?>/../assets/js/charts/widgetcharts.js"></script>
    
    <!-- mapchart Script -->
    <script src="<?=Url::base()?>/../assets/js/charts/vectore-chart.js"></script>
    <script src="<?=Url::base()?>/../assets/js/charts/dashboard.js"></script>
    
    <!-- fslightbox Script -->
    <script src="<?=Url::base()?>/../assets/js/plugins/fslightbox.js"></script>
    
    <!-- Settings Script -->
    <script src="<?=Url::base()?>/../assets/js/plugins/setting.js"></script>
    
    <!-- Form Wizard Script -->
    <script src="<?=Url::base()?>/../assets/js/plugins/form-wizard.js"></script>
    
    <!-- AOS Animation Plugin-->
    
    <!-- App Script -->
    <script src="<?=Url::base()?>/../assets/js/hope-ui.js" defer=""></script>
